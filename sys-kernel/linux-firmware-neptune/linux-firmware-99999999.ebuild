...
if [[ ${PV} == 99999999* ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://gitlab.com/evlaV/${PN}.git"
	S="${WORKDIR}/${PN}"
else
	SRC_URI="https://gitlab.com/evlaV/${PN}/-/archive/${PV}/${P}.tar.gz"
	S="${WORKDIR}/${P}"

	KEYWORDS="~amd64"
fi

DESCRIPTION="Linux firmware files for Steam Deck"
HOMEPAGE="https://gitlab.steamos.cloud/jupiter/linux-firmware-neptune"
